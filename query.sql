...
/
--------------------------------------------------------
--  DDL for Sequence DOS
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."DOS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ID_PACIENTE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."ID_PACIENTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ID_REGISTRO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."ID_REGISTRO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence ID_VACUNA
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."ID_VACUNA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence INCREMENTO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."INCREMENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence INCREMENTO2
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."INCREMENTO2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence INCREMENTO3
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."INCREMENTO3"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."UNO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DIRECCION" 
   (	"ID" NUMBER(*,0), 
	...
	"NO_CASA" VARCHAR2(10 CHAR), 
	"CALLE" VARCHAR2(20 CHAR), 
	"COLONIA" VARCHAR2(25 CHAR), 
	"MUNICIPIO" VARCHAR2(25 CHAR), 
	"PAIS_ID" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PAIS" 
   (	"ID" NUMBER(*,0), 
	"NOMBRE" VARCHAR2(35 CHAR), 
	"COD_POSTAL" VARCHAR2(10 CHAR)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PRODUCTO" 
   (	"ID" NUMBER(*,0), 
	...
	"MARCA" VARCHAR2(35 CHAR), 
	"DESCRIPCION" CLOB, 
	"PRECIO" FLOAT(6), 
	"Sub-Categoria_Id" NUMBER(*,0), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table Sub-Categoria
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."Sub-Categoria" 
   (	"ID" NUMBER(*,0), 
	"NOMBRE" VARCHAR2(35 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."TARJETA" 
   (	"ID" NUMBER(*,0), 
	"NOMBRE_TITULAR" VARCHAR2(30 CHAR), 
	"NO_TARJETA" VARCHAR2(30 CHAR), 
	"TIPO" VARCHAR2(25 CHAR), 
	"CVV" VARCHAR2(3 CHAR), 
	"FECHA_VENC" DATE, 
	"METODO" VARCHAR2(25 CHAR)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."USUARIO" 
   (	"ID" NUMBER(*,0), 
	...
	"APELLIDO" VARCHAR2(25 CHAR), 
	"TELEFONO" VARCHAR2(15 CHAR), 
	"MAIL" VARCHAR2(40 CHAR), 
	"CONTRASENIA" VARCHAR2(20 CHAR)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.CARRITO
SET DEFINE OFF;
REM INSERTING into SYSTEM.CATEGORIA
SET DEFINE OFF;
Insert into SYSTEM.CATEGORIA (ID,NOMBRE) values (1,'Electronicos');
Insert into SYSTEM.CATEGORIA (ID,NOMBRE) values (2,'Bebé');
Insert into SYSTEM.CATEGORIA (ID,NOMBRE) values (3,'Moda para Mujer');
Insert into SYSTEM.CATEGORIA (ID,NOMBRE) values (4,'Moda para hombre');
Insert into SYSTEM.CATEGORIA (ID,NOMBRE) values (5,'Computadoras');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.FOTO
SET DEFINE OFF;
Insert into SYSTEM.FOTO (ID,FOTO,PRODUCTO_ID) values (1,'https://www.mastersintime.com/pictures/fossil-44mm-townsman-fs5437-8937587.jpg',1);
Insert into SYSTEM.FOTO (ID,FOTO,PRODUCTO_ID) values (2,'https://www.brandfield.es/media/catalog/product/cache/image/9df78eab33525d08d6e5fb8d27136e95/4/0/4051432000256.jpg',1);
Insert into SYSTEM.FOTO (ID,FOTO,PRODUCTO_ID) values (3,'https://images-na.ssl-images-amazon.com/images/I/71YfgteItSL._AC._SR360,460.jpg',2);
Insert into SYSTEM.FOTO (ID,FOTO,PRODUCTO_ID) values (4,'https://images-na.ssl-images-amazon.com/images/I/61C+p9JnJzS._AC_UL604_SR604,400_.jpg',2);
Insert into SYSTEM.FOTO (ID,FOTO,PRODUCTO_ID) values (5,'https://cdn.shopify.com/s/files/1/1161/3498/products/ralph-lauren-polo-verde-para-hombre-118-ml-1_large.jpg?v=1571445838',3);
Insert into SYSTEM.FOTO (ID,FOTO,PRODUCTO_ID) values (6,'https://http2.mlstatic.com/D_NQ_NP_823633-MLU45643955705_042021-O.jpg',3);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PAIS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PRODUCTO
SET DEFINE OFF;
Insert into SYSTEM.PRODUCTO (ID,NOMBRE,MARCA,PRECIO,"Sub-Categoria_Id",PROVEEDOR_ID,TEMPORADA_ID) values (1,'Reloj hombre','Fosil',950,1,3,1);
Insert into SYSTEM.PRODUCTO (ID,NOMBRE,MARCA,PRECIO,"Sub-Categoria_Id",PROVEEDOR_ID,TEMPORADA_ID) values (2,'Pantalon Bebé','Gap',150,2,4,2);
Insert into SYSTEM.PRODUCTO (ID,NOMBRE,MARCA,PRECIO,"Sub-Categoria_Id",PROVEEDOR_ID,TEMPORADA_ID) values (3,'Perfume para hombre','Polo',370,4,1,1);
REM INSERTING into SYSTEM.PROVEEDOR
SET DEFINE OFF;
Insert into SYSTEM.PROVEEDOR (ID,NOMBRE,TELEFONO,CORREO) values (1,'Seven Five','2365214','seven25@gmail.com');
Insert into SYSTEM.PROVEEDOR (ID,NOMBRE,TELEFONO,CORREO) values (2,'Samsung','23658962','samsung32d@gmail.com');
Insert into SYSTEM.PROVEEDOR (ID,NOMBRE,TELEFONO,CORREO) values (3,'Fosil','36587563','foss365@gmail.com');
Insert into SYSTEM.PROVEEDOR (ID,NOMBRE,TELEFONO,CORREO) values (4,'Imporopa','23654789','ropausa25@gmail.com');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM."Sub-Categoria"
SET DEFINE OFF;
Insert into SYSTEM."Sub-Categoria" (ID,NOMBRE,CATEGORIA_ID) values (1,'Smartphone y accesorios',1);
Insert into SYSTEM."Sub-Categoria" (ID,NOMBRE,CATEGORIA_ID) values (2,'Audifonos',1);
Insert into SYSTEM."Sub-Categoria" (ID,NOMBRE,CATEGORIA_ID) values (3,'Actividad y entretenimiento',2);
Insert into SYSTEM."Sub-Categoria" (ID,NOMBRE,CATEGORIA_ID) values (4,'Ropa',3);
REM INSERTING into SYSTEM.TARJETA
SET DEFINE OFF;
REM INSERTING into SYSTEM.TEMPORADA
SET DEFINE OFF;
Insert into SYSTEM.TEMPORADA (ID,NOMBRE,FECHA_INICIO,FECHA_FIN) values (1,'Verano',to_date('01/02/22','DD/MM/RR'),to_date('01/05/22','DD/MM/RR'));
Insert into SYSTEM.TEMPORADA (ID,NOMBRE,FECHA_INICIO,FECHA_FIN) values (2,'Invierno',to_date('01/05/22','DD/MM/RR'),to_date('31/10/22','DD/MM/RR'));
Insert into SYSTEM.TEMPORADA (ID,NOMBRE,FECHA_INICIO,FECHA_FIN) values (3,'Navideña',to_date('01/11/22','DD/MM/RR'),to_date('31/01/23','DD/MM/RR'));
REM INSERTING into SYSTEM.USUARIO
SET DEFINE OFF;
REM INSERTING into SYSTEM.VENTA
SET DEFINE OFF;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PAGO_PK" ON "SYSTEM"."PAGO" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PAIS_PK" ON "SYSTEM"."PAIS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PRODUCTO_PK" ON "SYSTEM"."PRODUCTO" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."PROVEEDOR_PK" ON "SYSTEM"."PROVEEDOR" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index Sub-Categoria_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."Sub-Categoria_PK" ON "SYSTEM"."Sub-Categoria" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."TARJETA_PK" ON "SYSTEM"."TARJETA" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."TEMPORADA_PK" ON "SYSTEM"."TEMPORADA" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."VENTA_PK" ON "SYSTEM"."VENTA" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CARRITO_PK" ON "SYSTEM"."CARRITO" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CATEGORIA_PK" ON "SYSTEM"."CATEGORIA" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."CLIENTE_PK" ON "SYSTEM"."CLIENTE" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."DIRECCION_PK" ON "SYSTEM"."DIRECCION" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."ENVIO_PK" ON "SYSTEM"."ENVIO" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."FACTURA_PK" ON "SYSTEM"."FACTURA" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."FOTO_PK" ON "SYSTEM"."FOTO" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."VENTA__IDX" ON "SYSTEM"."VENTA" ("FACTURA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table Sub-Categoria
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."Sub-Categoria" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."Sub-Categoria" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."Sub-Categoria" MODIFY ("CATEGORIA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."Sub-Categoria" ADD CONSTRAINT "Sub-Categoria_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TEMPORADA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEMPORADA" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEMPORADA" MODIFY ("FECHA_INICIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEMPORADA" MODIFY ("FECHA_FIN" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TEMPORADA" ADD CONSTRAINT "TEMPORADA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRODUCTO" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTO" MODIFY ("MARCA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTO" MODIFY ("DESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTO" MODIFY ("Sub-Categoria_Id" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTO" MODIFY ("PROVEEDOR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTO" MODIFY ("TEMPORADA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRODUCTO" ADD CONSTRAINT "PRODUCTO_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PROVEEDOR" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROVEEDOR" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROVEEDOR" MODIFY ("TELEFONO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROVEEDOR" MODIFY ("CORREO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROVEEDOR" ADD CONSTRAINT "PROVEEDOR_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CATEGORIA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIA" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CATEGORIA" ADD CONSTRAINT "CATEGORIA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("FECHA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("TARJETA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" ADD CONSTRAINT "PAGO_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("NOMBRE_TITULAR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("NO_TARJETA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("TIPO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("CVV" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("FECHA_VENC" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" MODIFY ("METODO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TARJETA" ADD CONSTRAINT "TARJETA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FACTURA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURA" MODIFY ("CLIENTE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FACTURA" ADD CONSTRAINT "FACTURA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("FECHA_VENTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("PRODUCTO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("FACTURA_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("USUARIO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("PAGO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" MODIFY ("ENVIO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."VENTA" ADD CONSTRAINT "VENTA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("CIUDAD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("NO_CASA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("CALLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("COLONIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("MUNICIPIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" MODIFY ("PAIS_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DIRECCION" ADD CONSTRAINT "DIRECCION_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAIS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAIS" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAIS" MODIFY ("COD_POSTAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAIS" ADD CONSTRAINT "PAIS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ENVIO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ENVIO" MODIFY ("DIRECCION_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ENVIO" ADD CONSTRAINT "ENVIO_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLIENTE" MODIFY ("APELLIDO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLIENTE" MODIFY ("TELEFONO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLIENTE" MODIFY ("NIT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CLIENTE" ADD CONSTRAINT "CLIENTE_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FOTO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FOTO" MODIFY ("FOTO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FOTO" MODIFY ("PRODUCTO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."FOTO" ADD CONSTRAINT "FOTO_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIO" MODIFY ("APELLIDO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USUARIO" MODIFY ("TELEFONO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USUARIO" MODIFY ("MAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USUARIO" MODIFY ("CONTRASENIA" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CARRITO" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CARRITO" MODIFY ("CANTIDAD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CARRITO" MODIFY ("TOTAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CARRITO" MODIFY ("PRODUCTO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CARRITO" ADD CONSTRAINT "CARRITO_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CARRITO" ADD CONSTRAINT "CARRITO_PRODUCTO_FK" FOREIGN KEY ("PRODUCTO_ID")
	  REFERENCES "SYSTEM"."PRODUCTO" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DIRECCION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DIRECCION" ADD CONSTRAINT "DIRECCION_PAIS_FK" FOREIGN KEY ("PAIS_ID")
	  REFERENCES "SYSTEM"."PAIS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ENVIO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ENVIO" ADD CONSTRAINT "ENVIO_DIRECCION_FK" FOREIGN KEY ("DIRECCION_ID")
	  REFERENCES "SYSTEM"."DIRECCION" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FACTURA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FACTURA" ADD CONSTRAINT "FACTURA_CLIENTE_FK" FOREIGN KEY ("CLIENTE_ID")
	  REFERENCES "SYSTEM"."CLIENTE" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FOTO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FOTO" ADD CONSTRAINT "FOTO_PRODUCTO_FK" FOREIGN KEY ("PRODUCTO_ID")
	  REFERENCES "SYSTEM"."PRODUCTO" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAGO" ADD CONSTRAINT "PAGO_TARJETA_FK" FOREIGN KEY ("TARJETA_ID")
	  REFERENCES "SYSTEM"."TARJETA" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRODUCTO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRODUCTO" ADD CONSTRAINT "PRODUCTO_PROVEEDOR_FK" FOREIGN KEY ("PROVEEDOR_ID")
	  REFERENCES "SYSTEM"."PROVEEDOR" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."PRODUCTO" ADD CONSTRAINT "Producto_Sub-Categoria_FK" FOREIGN KEY ("Sub-Categoria_Id")
	  REFERENCES "SYSTEM"."Sub-Categoria" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."PRODUCTO" ADD CONSTRAINT "PRODUCTO_TEMPORADA_FK" FOREIGN KEY ("TEMPORADA_ID")
	  REFERENCES "SYSTEM"."TEMPORADA" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table Sub-Categoria
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."Sub-Categoria" ADD CONSTRAINT "Sub-Categoria_Categoria_FK" FOREIGN KEY ("CATEGORIA_ID")
	  REFERENCES "SYSTEM"."CATEGORIA" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VENTA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."VENTA" ADD CONSTRAINT "VENTA_ENVIO_FK" FOREIGN KEY ("ENVIO_ID")
	  REFERENCES "SYSTEM"."ENVIO" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VENTA" ADD CONSTRAINT "VENTA_FACTURA_FK" FOREIGN KEY ("FACTURA_ID")
	  REFERENCES "SYSTEM"."FACTURA" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VENTA" ADD CONSTRAINT "VENTA_PAGO_FK" FOREIGN KEY ("PAGO_ID")
	  REFERENCES "SYSTEM"."PAGO" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VENTA" ADD CONSTRAINT "VENTA_PRODUCTO_FK" FOREIGN KEY ("PRODUCTO_ID")
	  REFERENCES "SYSTEM"."PRODUCTO" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."VENTA" ADD CONSTRAINT "VENTA_USUARIO_FK" FOREIGN KEY ("USUARIO_ID")
